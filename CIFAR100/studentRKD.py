...
def main():
    ...
    save = "RKD_28-10_teaches_28-1_{}_{}_{}_{}".format(args.hkd,args.temp,args.rkd,args.pool3)
    ...
    for epoch in range(200):
        print('Epoch: %d' % epoch)
        train(net,trainloader,scheduler, device, optimizer,teacher=teacher,lambda_hkd=args.hkd,lambda_rkd=args.rkd,temp=args.temp,classes=100,pool3_only=args.pool3)
